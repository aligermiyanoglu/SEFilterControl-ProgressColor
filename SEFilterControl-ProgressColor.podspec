...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A GUI library for customized slider'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
    Thank you Shady Elyaski for your contribution to open source community. This library is a modified version of https://github.com/ShadyElyaski/ios-filter-control. Minor customization to show different color with background
                       DESC
